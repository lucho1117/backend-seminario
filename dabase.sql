...
CREATE TABLE DETALLE_ALQUILER(
    ID_DETALLE_ALQUILER INT auto_increment PRIMARY KEY not null,
    ID_PRODUCTO INT NOT NULL,
    ID_FACTURA INT NOT NULL,
    ...
    FOREIGN KEY (ID_PRODUCTO) REFERENCES PRODUCTO(ID_PRODUCTO),
    FOREIGN KEY (ID_FACTURA) REFERENCES FACTURA(ID_FACTURA),
    FOREIGN KEY (ID_TIPO_ALQUILER) REFERENCES TIPO_ALQUILER(ID_TIPO_ALQUILER)
);
...
CREATE TABLE TIPO_MATERIA_PRIMA(
    ID_TIPO_MATERIA_PRIMA INT auto_increment PRIMARY KEY not null,
    NOMBRE varchar(100) not null,
    DESCRIPCION longtext,
    ACTIVO TINYINT(1),
    FECHA_CREACION date DEFAULT NULL,
...
CREATE TABLE MATERIA_PRIMA(
    ID_MATERIA_PRIMA INT auto_increment PRIMARY KEY not null,
...
CREATE TABLE TIPO_MAQUINARIA(
    ID_TIPO_MAQUINARIA INT auto_increment PRIMARY KEY not null,
    NOMBRE varchar(100) not null,
    DESCRIPCION longtext,
    ACTIVO TINYINT(1),
    FECHA_CREACION date DEFAULT NULL,
...
CREATE TABLE MAQUINARIA(
    ID_MAQUINARIA INT auto_increment PRIMARY KEY not null,
    ID_TIPO_MAQUINARIA INT NOT NULL,
    NOMBRE varchar(100) not null,
    DESCRIPCION longtext,
    PESO INT,
    EXTRACCION TINYINT(1),
    ACTIVO TINYINT(1),
    FECHA_CREACION date DEFAULT NULL,
    FECHA_ELIMINACION date DEFAULT NULL,
    ID_ELIMINO bigint(20),
...
CREATE TABLE DETALLE_PROCESO(
    ID_DETALLE_PROCESO INT auto_increment PRIMARY KEY not null,
...
CREATE TABLE EXTRACCION(
    ID_EXTRACCION INT auto_increment PRIMARY KEY not null,
    NOMBRE varchar(100) not null,
    DESCRIPCION longtext,
    FECHA_INICIO INT,
    FECHA_FIN INT,
...
CREATE TABLE DETALLE_EXTRACCION(
    ID_DETALLE_EXTRACCION INT auto_increment PRIMARY KEY not null,
    ...
    ID_ELIMINO bigint(20),
    FOREIGN KEY (ID_MATERIA_PRIMA) REFERENCES MATERIA_PRIMA(ID_MATERIA_PRIMA),
    FOREIGN KEY (ID_EXTRACCION) REFERENCES EXTRACCION(ID_EXTRACCION),
    FOREIGN KEY (ID_EMPLEADO) REFERENCES EMPLEADO(ID_EMPLEADO)
);
