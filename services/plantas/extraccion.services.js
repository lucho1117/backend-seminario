...
const extraccionModel = require('../../models/extraccion');
const extraccion = extraccionModel(sequelize, Sequelize);
...
exports.findAll = async () => {
  return extraccion.findAll({
      where: {
        activo: true,
      },
      order: [["idExtraccion", "DESC"]],
    })
    .then(response=>{
...
exports.update = async (obj) => {
	return extraccion
		.update(obj, {
			where: { idExtraccion: obj.idExtraccion },
		})
		.then((response) => {
			return responsesServices.success(response);
		})
...
exports.deleteById = async (obj) => {
	...
	return extraccion
		.update(aux, { where: { idExtraccion: obj.idExtraccion } })
		.then((response) => {
			return responsesServices.success(response);
		})
		.catch((error) => {
