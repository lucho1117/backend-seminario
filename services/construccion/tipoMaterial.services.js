...
const tipoMaterialModel = require('../../models/tipoMaterial');
const tipoMaterial = tipoMaterialModel(sequelize, Sequelize);
...
exports.findAll = async () => {
  return tipoMaterial.findAll({
      where: {
        activo: true,
      },
      order: [["idTipoMaterial", "DESC"]],
    })
    .then(response=>{
...
exports.update = async (obj) => {
	return tipoMaterial
		.update(obj, {
			where: { idTipoMaterial: obj.idTipoMaterial },
		})
		.then((response) => {
			return responsesServices.success(response);
		})
...
exports.deleteById = async (obj) => {
	...
	return tipoMaterial
		.update(aux, { where: { idTipoMaterial: obj.idTipoMaterial } })
		.then((response) => {
			return responsesServices.success(response);
		})
		.catch((error) => {
