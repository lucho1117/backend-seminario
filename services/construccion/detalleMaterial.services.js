...
exports.findAll = async () => {
  return detalleMaterial.findAll({
      where: {
        activo: true,
      },
      order: [["idDetalleMaterial", "DESC"]],
    })
    .then(response=>{
...
exports.update = async (obj) => {
	return detalleMaterial
		.update(obj, {
			where: { idDetalleMaterial: obj.idDetalleMaterial },
		})
		.then((response) => {
			return responsesServices.success(response);
		})
...
exports.deleteById = async (obj) => {
	...
	return detalleMaterial
		.update(aux, { where: { idDetalleMaterial: obj.idDetalleMaterial } })
		.then((response) => {
			return responsesServices.success(response);
		})
		.catch((error) => {
