...
exports.findAll = async () => {
  return detalleAlquiler.findAll({
      where: {
        activo: true,
      },
      order: [["idDetalleAlquiler", "DESC"]],
    })
    .then(response=>{
...
exports.update = async (obj) => {
	return detalleAlquiler
		.update(obj, {
			where: { idDetalleAlquiler: obj.idDetalleAlquiler },
		})
		.then((response) => {
			return responsesServices.success(response);
		})
...
exports.deleteById = async (obj) => {
	...
	return detalleAlquiler
		.update(aux, { where: { idDetalleAlquiler: obj.idDetalleAlquiler } })
		.then((response) => {
			return responsesServices.success(response);
		})
		.catch((error) => {
