...
const tipoPagoModel = require('../../models/tipoPago');
const tipoPago = tipoPagoModel(sequelize, Sequelize);
...
exports.update = async (obj) => {
	return tipoPago
		.update(obj, {
			where: { idTipoPago: obj.idTipoPago },
		})
		.then((response) => {
			return responsesServices.success(response);
		})
...
exports.deleteById = async (obj) => {
	...
	return tipoPago
		.update(aux, { where: { idTipoPago: obj.idTipoPago } })
		.then((response) => {
			return responsesServices.success(response);
		})
		.catch((error) => {
