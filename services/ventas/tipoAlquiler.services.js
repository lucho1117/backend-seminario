...
const tipoAlquilerModel = require('../../models/tipoAlquiler');
const tipoAlquiler = tipoAlquilerModel(sequelize, Sequelize);
...
exports.findAll = async () => {
  return tipoAlquiler.findAll({
      where: {
        activo: true,
      },
      order: [["idTipoAlquiler", "DESC"]],
    })
    .then(response=>{
...
exports.update = async (obj) => {
	return tipoAlquiler
		.update(obj, {
			where: { idTipoAlquiler: obj.idTipoAlquiler },
		})
		.then((response) => {
			return responsesServices.success(response);
		})
...
exports.deleteById = async (obj) => {
	...
	return tipoAlquiler
		.update(aux, { where: { idTipoAlquiler: obj.idTipoAlquiler } })
		.then((response) => {
			return responsesServices.success(response);
		})
		.catch((error) => {
