 ...
 * IMPORTS
 ************************************************************************/
 const { findAll, save, update, deleteById, findAllByRolArea } = require('../../services/empleado/empleado.services');
 ...
 exports.findAllByRolArea = async (req, res) => {
    let obj = req.body;
    const result = await findAllByRolArea(obj);
